...
export function getBadgeStyle(badge: TInsuranceBadge) {
  const styles = {
    mostPopular: { bg: "#F5D020", color: "#000" },
    trusted: { bg: "#4682B4", color: "#fff" },
    bestForPuppies: { bg: "#FF4D6D", color: "#fff" },
    mostFlexible: { bg: "#00E5CC", color: "#000" },
    bestPreventive: { bg: "#5aab1e", color: "#fff" },
    budgetPick: { bg: "#1E90FF", color: "#fff" },
  };
  return styles[badge];
}
                        ...
                        <div className="flex flex-wrap items-center gap-1.5 mb-0.5">
                          ...
                          {provider.badge && (
                            <Chip
                              ...
                              style={{
                                backgroundColor: getBadgeStyle(provider.badge)
                                  .bg,
