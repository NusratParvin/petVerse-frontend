...
//       className={`relative ${
//         depth > 0
//           ?  "pl-10 mt-4 before:absolute before:left-4 before:top-0 before:bottom-0 before:w-px before:bg-zinc-300 dark:before:bg-zinc-700"
...
//           {/* Location pill */}
//           {!isEditing && commentData?.sightingLocation && (
...
/* curved SVG line from parent's footer down to child's avatar,        */
/* with tiny paw-prints walking along the curve.                       */
const PawConnector = () => (
  <span
    aria-hidden
