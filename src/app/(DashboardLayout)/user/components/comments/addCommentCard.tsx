...
const AddCommentCard = ({ targetType, targetId }: AddCommentCardProps) => {
  ...
  return (
    <div className="rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 p-3 space-y-3">
        ...
        <div className="flex-1 space-y-2">
          ...
          {!isExpanded ? (
            <button
              ...
              className="w-full text-left px-4 py-2.5 rounded-lg bg-zinc-100 dark:bg-zinc-800/60 text-zinc-400 dark:text-zinc-500 text-sm hover:bg-zinc-200 dark:hover:bg-zinc-800 transition-colors"
            >
              {isLostFound
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-2">
              ...
              <Textarea
                ...
                classNames={{
                  ...
                  inputWrapper:
                    "bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 hover:border-steel-blue dark:hover:border-lime-burst transition-colors",
                }}
              />
              ...
              {isLostFound && isSighting && (
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-4 py-2 text-sm rounded-lg bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-800 dark:text-zinc-200 placeholder-zinc-400 focus:outline-none focus:border-steel-blue dark:focus:border-lime-burst transition-colors"
                  />
                </div>
              )}
